...
namespace ChatSample
{
 public class CanvasManager : MonoBehaviour
 {
	...
	public GameObject hudUserList; // set in inspector. stores the  User List Panel
	
	public GameObject chatRoom; // set in inspector. stores the  chat Room Panel
	
	public GameObject hudChooseAvatar;  // set in inspector. stores the  Choose Avatar Panel
	...
	public void  OpenScreen(string _current)
	{
		switch (_current)
		{
			...
			hudUserList.SetActive(false);
	        chatRoom.SetActive(false);
			break;
			case "room":
			currentHUD = _current;
			hudSignIn.SetActive(false);
			hudUserList.SetActive(true);
	        chatRoom.SetActive(true);
			break;
			case "chooseAvatar":
			 hudChooseAvatar.SetActive(true);
			break;
	...
	public void SetUpcurrentSkin(int _avatar_index)
	{
	  ...
	  hudChooseAvatar.SetActive(false);
	}
