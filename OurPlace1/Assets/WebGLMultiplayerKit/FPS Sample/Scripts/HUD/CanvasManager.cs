...
public class CanvasManager : MonoBehaviour
{
   ...
   [Header("Canvas HUD's :")]
	public GameObject  HUDLobby; // set in inspector. stores the Lobby Panel.
	
	public GameObject  gameCanvas; // set in inspector. variable that stores the Game Canvas panel
	
	public GameObject alertgameDialog;// set in inspector. variable that stores the AlertGameDialog panel
